...
const ROW_LABEL_ACCENT = [
    "border-l-4 border-l-rose-400 shadow-[inset_6px_0_12px_-4px_rgba(251,113,133,0.35)]",
    "border-l-4 border-l-orange-400 shadow-[inset_6px_0_12px_-4px_rgba(251,146,60,0.35)]",
    "border-l-4 border-l-amber-400 shadow-[inset_6px_0_12px_-4px_rgba(251,191,36,0.35)]",
    "border-l-4 border-l-lime-400 shadow-[inset_6px_0_12px_-4px_rgba(163,230,53,0.35)]",
    "border-l-4 border-l-emerald-400 shadow-[inset_6px_0_12px_-4px_rgba(52,211,153,0.35)]",
    "border-l-4 border-l-cyan-400 shadow-[inset_6px_0_12px_-4px_rgba(34,211,238,0.35)]",
    "border-l-4 border-l-sky-400 shadow-[inset_6px_0_12px_-4px_rgba(56,189,248,0.35)]",
    "border-l-4 border-l-fuchsia-400 shadow-[inset_6px_0_12px_-4px_rgba(232,121,249,0.35)]",
];
    ...
    return (
        ...
        <div className="w-full overflow-hidden rounded-2xl border-2 border-stage-gold/25 bg-gradient-to-b from-[#1a1535]/95 to-stage-panel/90 p-1 shadow-[0_24px_60px_rgba(0,0,0,0.5),0_0_0_1px_rgba(244,208,63,0.12),inset_0_1px_0_rgba(255,255,255,0.09)] backdrop-blur-sm sm:p-1.5">
            ...
            <div className="mb-5 flex flex-col gap-4">
                ...
                <div className="flex flex-wrap items-center gap-3 rounded-xl border border-violet-500/25 bg-gradient-to-r from-violet-950/50 via-slate-900/40 to-cyan-950/30 px-4 py-3 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.05)]">

                    <span className="font-display text-sm uppercase tracking-[0.2em] text-stage-gold/95 drop-shadow-sm sm:text-base">
                    ...
                    <div className="flex h-5 items-end gap-0.5" aria-hidden>
                        ...
                        {[0, 1, 2, 3, 4].map((i) => (
                            ...
                            <span
                                ...
                                className="notes-eq-bar w-1 rounded-sm bg-gradient-to-t from-emerald-600 to-stage-mint"
            ...
            <div className="relative [perspective:1000px]">
                ...
                <div
                    ...
                    className="relative overflow-x-auto rounded-2xl border-4 border-zinc-700/90 bg-gradient-to-br from-slate-900 via-zinc-950 to-black p-2 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.07),0_20px_50px_rgba(0,0,0,0.65),0_0_40px_rgba(91,33,182,0.12)] [-webkit-overflow-scrolling:touch]"
                            ...
                            >
                                ...
                                {Array.from({ length: COLS }, (_, col) => (
                                    ...
                                    <td
                                        ...
                                        className={`${cellClassName(row, col)} h-12 w-4 cursor-crosshair border border-black/90 ${

                                            col === 16

                                                ? "!border-l-8 !border-l-stage-gold"
